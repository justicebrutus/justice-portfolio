...
const metadata: Record<string, { title: string; description: string }> = {
  ...
  "/work/carryover": { title: "Carryover product case study — Justice Brutus", description: "A plant-operations product for shift continuity, accountable action, and evidence-backed resolution." },
