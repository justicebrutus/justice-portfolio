...
const metadata: Record<string, { title: string; description: string }> = {
  "/": { title: "Justice Brutus — Frontend Developer & Design Engineer", description: "React and TypeScript product engineering focused on clear workflows, accessible interaction, and responsive systems." },
  ...
  "/resume": { title: "Résumé — Justice Brutus", description: "Frontend development and design engineering work, technical capabilities, and operating experience." },
};
